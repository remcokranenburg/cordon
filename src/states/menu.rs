...
use crate::{despawn_screen, AppState, CORDON_GREEN, CORDON_GREEN_HIGHLIGHT};
...
fn button_system(
    ...
    for (interaction, mut background_color, selected) in &mut interaction_query {
        *background_color = match (*interaction, selected) {
            (Interaction::Pressed, _) | (Interaction::None, Some(_)) => CORDON_GREEN_HIGHLIGHT.into(),
            (Interaction::Hovered, Some(_)) => CORDON_GREEN_HIGHLIGHT.into(),
            (Interaction::Hovered, None) => CORDON_GREEN.into(),
        ...
        children![(
            ...
            children![
                ...
                (
                    ...
                    children![(Text::new("Quit"), button_text_font, TextColor(CORDON_GREEN),),]
                ),
            ]
        )],
    ));
